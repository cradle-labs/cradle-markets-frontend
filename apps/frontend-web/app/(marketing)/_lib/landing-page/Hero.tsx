...
// @ts-ignore
import bgDarkSrc from './images/abstract.jpg'
// @ts-ignore
import bgLightSrc from './images/abstract-white.png'
        ...
        <Center h="full" justifyContent="start">
          <VStack alignItems="start" spacing="xl">
            ...
            <WordsPullUp
              ...
              lineHeight={1}
              pr="2"
              text="Securities made accessible"
            />
            <MotionHeading
              animate={
                shouldAnimate
            ...
            <HStack alignItems="center" mt="xl" spacing="md">
              <MotionBox
                ...
                as={Link}
                h="56px"
                href="https://youtu.be/cradle-protocol-demo"
                initial={{ opacity: 0 }}
                overflow="hidden"
                position="relative"
                rel="noopener"
