              ...
              <FadeInOnView>
                <div className="subsection">
                  ...
                  <p>
                    ...
                    burden for LPs, higher swap fees and better capital efficiency when in range,
                    they introduce specific risk.
                  </p>
                  <ul>
                    <li>
                      ...
                      that in this case can be potentially exacerbated by suboptimal range, margin
                      and “daily price shift exponent” adjustments. The efficacy of the parameters
                      in the mechanism which replaces manual LP intervention, introduces risks,
                      including (but not limited to): potential for miscalculation, inefficient
                      capital utilization, or exploitability if rebalancing patterns are
                      predictable.
                    </li>
                    <li>
                      ...
                      change, meaning the losses incurred to the asset in one side of the pool
                      during certain price fluctuations can become “permanent”.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      centeredness margin (the threshold for updates); 2) change the daily price
                      shift exponent (the speed of updates); and 3) initiate an update to the price
                      interval (i.e., the distance, or ratio, between the minimum and maximum price
                      bounds), or simply stop an ongoing update. All of these changes will update
                      the virtual balances and potentially slightly change the price.
                    </li>
                  </ul>
                </div>
              </FadeInOnView>
          ...
          <FadeInOnView>
            <div className="subsection">
              <p>
                ...
                the{' '}
                <a href="https://github.com/balancer/frontend-monorepo/blob/main/apps/frontend-web/app/(marketing)/risks/page.tsx">
                  Balancer Github
                </a>
                .
              </p>
