...
interface ListingSearchFiltersProps {
  ...
  setSelectedCategory: (category: ListingCategory) => void
  viewMode: ViewMode
...
const sortOptions: SortSelectOption[] = [
  ...
  { value: 'supply-desc', label: 'Supply (high to low)' },
  { value: 'supply-asc', label: 'Supply (low to high)' },
]
  ...
  return (
    <Box w="full">
      <Select<SortSelectOption, false, GroupBase<SortSelectOption>>
        ...
        instanceId="listing-sort-select"
        isSearchable={false}
        ...
        <HStack align="center" spacing={3}>
          ...
          <Box flex={1}>
            <SearchInput
              ...
              isLoading={isLoading}
              placeholder="Search listing name or asset"
              search={search}
              setSearch={setSearch}
            />
          </Box>
