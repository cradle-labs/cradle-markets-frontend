      ...
      >
            ...
            return (
              ...
              >
                <Box
                  ...
                  width={`${pct}%`}
                />
                <Text color="red.400" fontSize={'12px'} position="relative" zIndex={10}>
        ...
        >
          <Flex align="center" fontSize="xs" gap={3} justify="center">
            <Box>
              <Text as="span" color="font.secondary" fontSize="12px">
                Mid{' '}
              </Text>
            ...
            return (
              ...
              >
                <Box
                  ...
                  width={`${pct}%`}
                />
                <Text color="green.400" fontSize={'12px'} position="relative" zIndex={10}>
