...
import { MobileMoneyForm, CashMode } from '@repo/lib/shared/components/cash'
import Noise from '@repo/lib/shared/components/layout/Noise'
import { RadialPattern } from '@repo/lib/shared/components/zen/RadialPattern'

type CashPageProps = PropsWithChildren

export function CashPage({ children }: CashPageProps) {
  const [cashMode, setCashMode] = useState<CashMode>(CashMode.PAY)
  return (
    <>
              ...
              >
                <Box>
                  <Heading pb="3" sx={{ textWrap: 'balance' }} variant="special">
                    Cash in and out instantly
                  </Heading>
                  <Text sx={{ textWrap: 'balance' }} variant="secondary">
                    Convert your assets to cash in seconds
                  </Text>
                </Box>
              </VStack>
            </FadeInOnView>
