    ...
    colors: {
      light: {
        background: {
          ...
          level0WithOpacity: 'rgba(245, 247, 250, 0.5)',
        ...
        border: {
          ...
          subduedZen: 'rgba(63, 94, 251, 0.05)',
        ...
        input: {
          ...
          fontFocus: 'gray.900',
          fontPlaceholder: tinycolor(colors.gray['500']).setAlpha(0.5),
          ...
          bgErrorFocus: 'rgba(255, 255, 255, 1)',
      ...
      dark: {
        ...
        text: {
          ...
          primaryGradient: 'linear-gradient(to right, #3F5EFB, #FC466B)',
