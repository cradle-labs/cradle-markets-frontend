...
export function shouldIgnore(message: string, stackTrace = ''): boolean {
  ...
  */
  ...
  /*
    ...
    Examples: https://cradle-labs.sentry.io/issues/6241233852/?project=4506382607712256
   */
  if (
  ...
  */
  ...
  /*
    ...
    Examples: https://cradle-labs.sentry.io/issues/5623611453/
  */
  if (
  ...
  /*
    ...
    Examples: https://cradle-labs.sentry.io/issues/5687846148/
  */
  ...
  */
  ...
  /*
    ...
    Examples: https://cradle-labs.sentry.io/issues/5622743248/
  */
  if (
    message ===
  ...
  */
  ...
  /*
    ...
    The source https://cradleprotocol.com/[URI] has not been authorized yet

    We cannot reproduce but it looks like it does not crash the app.

    First time seen in sentry: September 4th, 2024
    https://vercel.com/cradle/frontend-web/deployments?range={%22start%22:%222024-09-02T22:00:00.000Z%22,%22end%22:%222024-09-03T21:59:59.999Z%22}

    Examples: https://cradle-labs.sentry.io/issues/5796181794
  */
  if (
    message.includes('The source https://cradleprotocol.com') &&
  ...
  /*
    ...
    Context: https://github.com/cradle-protocol/cradle-maths/blob/8aaf871acd9e138ba855f03be723cdfd630f4246/typescript/src/weighted/weightedMath.ts#L10
    */
