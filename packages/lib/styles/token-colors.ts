...
// Stub GqlChain enum until graphql is properly set up
enum GqlChain {
  Mainnet = 'MAINNET',
  Arbitrum = 'ARBITRUM',
  Optimism = 'OPTIMISM',
...
// Stub function for getGqlChain until graphql is properly set up
function getGqlChain(chainId: number): GqlChain {
  const chainMap: Record<number, GqlChain> = {
    1: GqlChain.Mainnet,
    42161: GqlChain.Arbitrum,
    10: GqlChain.Optimism,
    8453: GqlChain.Base,
    137: GqlChain.Polygon,
    43114: GqlChain.Avalanche,
    250: GqlChain.Fantom,
    100: GqlChain.Gnosis,
    1101: GqlChain.Zkevm,
    11155111: GqlChain.Sepolia,
    34443: GqlChain.Mode,
    252: GqlChain.Fraxtal,
  }
  return chainMap[chainId] || GqlChain.Mainnet
}
